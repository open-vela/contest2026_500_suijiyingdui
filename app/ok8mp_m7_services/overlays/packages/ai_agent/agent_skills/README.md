...
| OK8MP硬件 | ok8mp-voice-light-control | voice_status → set_voice_rgb / set_voice_buzzer |
| OK8MP联网 | ok8mp-network-guardian | voice_status → set_voice_rgb(蓝) → network_health_check → 绿灯/红灯+蜂鸣 |
