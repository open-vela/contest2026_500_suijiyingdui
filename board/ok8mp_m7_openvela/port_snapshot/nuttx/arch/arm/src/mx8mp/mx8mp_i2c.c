...
{
  /* Start from a known controller state.  U-Boot or Linux may have used the
   * controller before bootaux starts the M7; merely setting IEN preserves
   * stale MSTA/MTX/RSTA state and can report IAL (-EACCES) on every byte. */
